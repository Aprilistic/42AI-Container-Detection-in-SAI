...
# mv pytorch-rotation-decoupled-detector/images/val/images/* pytorch-rotation-decoupled-detector/images/val
...
# rm -rf pytorch-rotation-decoupled-detector/labelTxt/train/*.zip